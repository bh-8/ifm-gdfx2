...
\begin{table}[!h]
    ...
    \begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|c|}
        \hline
        \multirow{2}{*}{\makecell[l]{\textbf{Modellkonfiguration}\\(Merkmalsextraktor, Sequenzlänge)}} & \multirow{2}{*}{\makecell{\textbf{Zeit}\\pro Item}} & \multicolumn{3}{c|}{\textbf{Precision}} & \multicolumn{3}{c|}{\textbf{Recall}} & \multirow{2}{*}{\makecell{\textbf{F1-Score}\\(gewichtet)}} \\\cdashline{3-8}
...
\begin{table}[!h]
    ...
    \begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|c|}
        ...
        \effnet-08 & 40 $\text{ms}$ & 0.7288 & 0.9051 & 0.8508 & 0.9889 & 0.7471 & 0.9190 & 0.8468 (0.8565) \\\hline
