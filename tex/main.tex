...
\begin{table}[!h]
    ...
    \begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|c|c|c|c|c|c|}
        \hline
        \multirow{2}{*}{\makecell[l]{\textbf{Modellkonfiguration}\\(Merkmalsextraktor, Sequenzlänge)}} & \multirow{2}{*}{\makecell{\textbf{Zeit}\\pro Item}} & \multicolumn{4}{c|}{\textbf{Precision}} & \multicolumn{4}{c|}{\textbf{Recall}} & \multicolumn{4}{c|}{\textbf{F1-Score}} \\\cdashline{3-14}
