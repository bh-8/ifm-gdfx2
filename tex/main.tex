...
df40/
    ...
    \begin{enumerate}
        ...
        \item\textbf{BiLSTM-Layer}:
            Die aufeinander folgenden Einzelbilder der zu klassifizierenden Sequenz werden in dieser Schicht 
            Anschließend folgt ein bidirektionales LSTM.
