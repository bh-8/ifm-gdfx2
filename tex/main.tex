...
\begin{table}[!h]
    ...
    \begin{tabularx}{\textwidth}{|X||c|c|c|c|}
        \hline
        \textbf{Modellkonfiguration} & \textbf{Precision} & \textbf{Recall} & \textbf{F1-Score} & \textbf{F1-Score (gewichtet)} \\\hline\hline
        \resnet, 8 SL, 12 BS &  &  &  &  \\\hline
        \resnet, 12 SL, 8 BS &  &  &  &  \\\hline
        \resnet, 16 SL, 4 BS &  &  &  &  \\\hline
        \effnet, 8 SL, 12 BS &  &  &  &  \\\hline
        \effnet, 12 SL, 8 BS &  &  &  &  \\\hline
        \effnet, 16 SL, 4 BS &  &  &  &  \\\hline
    \end{tabularx}
