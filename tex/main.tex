...
\begin{table}[!h]
    ...
    \begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|c|}
        \hline
        \multirow{2}{*}{\textbf{Modellkonfiguration}} & \multirow{2}{*}{\textbf{FPS}} & \multicolumn{3}{c|}{\textbf{Precision}} & \multicolumn{3}{c|}{\textbf{Recall}} & \multirow{2}{*}{\makecell{\textbf{F1-Score}\\(gewichtet)}} \\\cdashline{3-8}
